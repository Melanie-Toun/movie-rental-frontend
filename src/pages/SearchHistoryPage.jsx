...
//           <h1 className=" text-3xl mt-10 font-bold mb-8">Search History</h1>
//           <div className="flex justify-center items-center h-96">
//           <p className="text-center text-xl">No search history found.</p>
//           </div>
//         </div>
//       </div>
//     )
...
//             <span className={`py-1 px-3 min-w-20 text-center rounded-full text-sm ml-auto ${entry.searchType === "movie" ? "bg-red-700" : entry.searchType === "tv" ? "bg-blue-500" : "bg-green-500"}`}>
//               {entry.searchType[0]. toUpperCase() + entry.searchType.slice(1)}</span>
//               <Trash className="size-5 ml-4 cursor-pointer hover:fill-red-800 hover:text-red-600" onClick={() => handleDelete(entry)}/>
//           </div>
//         ))}
//       </div>
//       </div>
