...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full hero-bg flex flex-col">
      <header className="max-w-6xl mx-auto flex items-center justify-between p-4">
        <Link to={"/"}>
          <img src="/ms.svg" alt="logo" className="w-40 sm:w-52" />
        </Link>
      </header>
      ...
      <div className="flex justify-center items-center flex-1 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md p-6 sm:p-8 space-y-6 bg-black/60 rounded-lg shadow-md">
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <button className="w-full py-2 bg-red-600 text-white font-semibold rounded-md hover:bg-red-700 transition-all">
              Log In
            </button>
          </form>
